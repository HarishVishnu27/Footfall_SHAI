...
RTSP_URLS = {
    'cam1': "rtsp://192.168.0.121:554/rtsp/streaming?channel=1&subtype=1&onvif_metadata=true",
    'cam2': "rtsp://192.168.0.122:554/rtsp/streaming?channel=1&subtype=1&onvif_metadata=true",
    'cam3': "rtsp://192.168.0.123:554/rtsp/streaming?channel=1&subtype=1&onvif_metadata=true",
    ...
    def analyze_and_save(self, frame, result):
        ...
        if result is not None:
            try:
                ...
                vdc = (r1_density >= 40) or (weighted_density >=30)
